...
<<<<<<< HEAD
  BookOpen, Star, MessageCircle, Shield, ChevronLeft, HelpCircle
=======
...
<<<<<<< HEAD
  ...
  const getDashboardRoute = () => {
    switch (role) {
      case "traveller": return "/dashboard/traveller";
...
<<<<<<< HEAD
        ...
        <div className="flex flex-col h-[calc(100vh-64px)]"> {/* 64px = h-16 header */}
