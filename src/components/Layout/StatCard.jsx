...
//     <Card
//       {...(to ? { to } : {})}
//       className={`relative overflow-hidden rounded-2xl p-5 shadow-sm ring-1 ring-gray-200/70 dark:ring-gray-800/70
//         ${subtle ? "bg-white dark:bg-gray-900" : "bg-white dark:bg-gray-800"}
//         hover:shadow-md transition`}
//     >
//       <div className="flex items-start justify-between gap-4">
//         <div className="inline-flex items-center justify-center w-10 h-10 rounded-lg shrink-0
//            bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 ring-1 ring-gray-200/70 dark:ring-gray-700">
//           <Icon className="h-5 w-5 text-gray-700 dark:text-gray-300" />
//         </div>
//         {trend && (
//           <div className={`text-xs font-medium inline-flex items-center gap-1 ${trend.direction === "up" ? "text-emerald-600" : "text-rose-600"}`}>
...
//       <div className="pointer-events-none absolute bottom-0 left-0 right-0 h-1.5 bg-gradient-to-r from-primary-500/10 via-primary-500/20 to-transparent" />
//     </Card>
//   );
// }
import React from "react";
