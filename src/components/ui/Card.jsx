...
//     const base =
//       variant === "glass"
//         ? "bg-glass dark:bg-darkGlass backdrop-blur-md rounded-2xl border border-white/20 shadow-lg"
...
//         className={cn(
//           base,
//           interactive && "transition hover:shadow-xl hover:-translate-y-0.5",
//           className
//         )}
//         {...props}
//       >
...
//   ({ as: Comp = "div", className = "", variant = "glass", children, ...props }, ref) => (
//     <Comp
//       ref={ref}
//       className={cn(
//         "px-6 py-4",
...
//   ({ as: Comp = "h3", className = "", variant = "glass", children, ...props }, ref) => (
//     <Comp
//       ref={ref}
//       className={cn(
...
//   ({ as: Comp = "p", className = "", variant = "glass", children, ...props }, ref) => (
//     <Comp
//       ref={ref}
//       className={cn(
//         "mt-1 text-sm",
//         variant === "glass" ? "text-gray-200" : "text-gray-600 dark:text-gray-400",
//         className
//       )}
//       {...props}
//     >
