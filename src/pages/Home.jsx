...
// import { Search, MapPin, Calendar, Users, Star, TrendingUp } from 'lucide-react';
...
//         api.get('/places?featured=true&limit=6'),
//         api.get('/activities?featured=true&limit=8')
//       ]);
      
//       setFeaturedPlaces(placesRes.data.data);
//       setFeaturedActivities(activitiesRes.data.data);
//     } catch (error) {
...
//               Discover Amazing
//               <span className="block text-yellow-300">Local Experiences</span>
//             </h1>
...
//                   <select className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent text-gray-900 appearance-none bg-white">
...
//                       <span className="bg-white/90 backdrop-blur text-gray-900 px-2 py-1 rounded-full text-sm font-medium">
//                         {place.city}
//                       </span>
//                     </div>
//                   </div>
//                   <CardContent className="p-4">
//                     <h3 className="text-lg font-semibold text-gray-900 mb-2 group-hover:text-primary-600 transition-colors dark:text-white">
//                       {place.title}
//                     </h3>
...
//                         <span className="text-sm font-medium">{place.rating.avg.toFixed(1)}</span>
//                         <span className="text-sm text-gray-500">({place.rating.count})</span>
//                       </div>
...
//             </h2>
//             <p className="text-lg text-gray-600 dark:text-gray-300">
//               Unique experiences curated by local experts
//             </p>
//           </div>
...
//                   <Card className="group hover:shadow-xl transition-shadow cursor-pointer">
//                     <div className="aspect-w-4 aspect-h-3 relative overflow-hidden rounded-t-xl">
//                       <div className="w-full h-40 bg-gradient-to-br from-secondary-400 to-secondary-600 flex items-center justify-center">
//                         <div className="text-4xl">
//                           {activity.category === 'heritage' ? '🏛️' :
...
//                     </div>
//                     <CardContent className="p-4">
//                       <h3 className="text-sm font-semibold text-gray-900 mb-2 line-clamp-2 group-hover:text-primary-600 transition-colors dark:text-white">
//                         {activity.title}
//                       </h3>
...
//               Join thousands of travelers discovering unique experiences worldwide
//             </p>
