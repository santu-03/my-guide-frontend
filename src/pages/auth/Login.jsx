...
// // ---- API base (matches your backend mount at /api) ----
...
//   const navigate = useNavigate();
//   const location = useLocation();
//   const { isLoading } = useAuthStore(); // keeping previous structure; no store login call
...
//     try {
//       // ⬇️ Axios login (replacing store login)
...
//       // persist auth (respect remember me)
...
//         case 'traveller':
//         default:
//           // if you prefer returning to the previous page:
//           // navigate(from, { replace: true });
